...
procedure main()
    ...
    local cHRBLoad as character
    local cHRBFile as character
    ...
    oDivPageHeaderH4:text:="MOD_HARBOUR :: XMLHTTP :: JSON-SERVER/JSON to Bootstrap table"
...
var dtbl=new createTable(
    ...
    addHarbourPRGFileAsCodeText(oHTMLDoc:body:Main:div,hb_getenv('PRGPATH')+'/09-json-server-json-to-Bootstrap-Table.prg')
