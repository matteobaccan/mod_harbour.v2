...
procedure main()
    ...
    cDbf:=hb_getenv('PRGPATH')+'/data/carts.dbf'
    use (cDbf) shared new
    ...
    oNode:text:="Bootstrap Table :: table-striped!"
    ...
    oTable:=oDiv:table
    oTable:attr:='class="table table-striped"'
    ...
    addHarbourPRGFileAsCodeText(oHTMLDoc:body:Main:div,hb_getenv('PRGPATH')+'/02-dbf-table-table-striped.prg')
